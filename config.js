...
const config = {
  name: "Billu Assistant",
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=1116668649403584573&permissions=8&scope=bot%20applications.commands",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
  ...
  serverCount: 18, //-  - Your
  memberCount: 890, //--   - Bot
  executedCommand: 2290, //--  - Stats
  availableCommand: 600, //---   - Here
